...
*   **[sm-evals](https://github.com/shivamhwp/sm-evals)**
     - ran beir bench and plotting diff graphs on supermemory v2 api.

*   **[git-acm](https://git.new/git-acm)** – rust cli to generate commit messages instantly using any model | powered by [openrouter](https://openrouter.ai/).
     - ![Crates.io Total Downloads](https://img.shields.io/crates/d/git-acm?labelColor=%23222&color=white)

*   **[isup](https://git.new/isup)** – on-device site monitor in rust
